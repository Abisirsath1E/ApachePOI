...
public class WebTableToExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		String path="D:\\ApachePOI\\ApachePOI\\datafiles\\population.xlsx";
		...
		//capture table rows
		//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody
		WebElement table=driver.findElement(By.xpath("//table[@class='wikitable sortable jquery-tablesorter\']/tbody"));
		int rows=table.findElements(By.xpath("tr")).size(); // rows present in web tabl"
